...
import { ArrowLeft, Edit3, X, Search, ChevronDown, ChevronUp } from 'lucide-react';
...
interface Program {
  id: string;
  project: string;
  members: { initials: string; gender: string }[];
  progress: number;
  status: string;
  estimatedStartDate: string;
  startDate: string;
...
<svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24">
  ...
  useEffect(() => {
    ...
    const fetchProgramData = async () => {
      try {
        const response = await fetch('/data/ProgramDetail.json');
        const programs = await response.json();
        const currentProgram = programs.find((p: Program) => p.id.toString() === id);
        if (currentProgram) {
    ...
    const mockTopics: Topic[] = [
      {
        ...
        members: [
          { initials: "AJ", gender: "female" },
          { initials: "BS", gender: "male" }
        ],
        status: "In Progress",
        progress: 75,
        estimatedStartDate: "01 Aug, 2025",
        startDate: "01 Aug, 2025",
        endDate: "-",
        estimatedEndDate: "01 Dec, 2025",
      ...
      },
      {
        ...
        members: [
          { initials: "FM", gender: "male" },
          { initials: "GL", gender: "female" }
        ],
        status: "In Progress",
        progress: 45,
        estimatedStartDate: "01 Aug, 2025",
      ...
      {
        id: "T-03",
        project: "UI Design Update",
        members: [
          { initials: "IB", gender: "female" },
          { initials: "JB", gender: "male" }
        ],
        status: "Not Started",
        progress: 0,
        estimatedStartDate: "15 Aug, 2025",
        startDate: "-",
        endDate: "-",
        estimatedEndDate: "15 Dec, 2025",
        estimatedDuration: "4 months",
        actualDuration: "-",
      ...
      },
      {
        ...
        status: "Completed",
        progress: 100,
        estimatedStartDate: "01 Jan, 2024",
        startDate: "01 Jan, 2024",
        endDate: "15 May, 2024",
        estimatedEndDate: "01 Apr, 2024",
      ...
      },
      {
        ...
        members: [
          { initials: "OP", gender: "female" },
          { initials: "QR", gender: "male" }
        ],
        status: "Cancelled",
        progress: 30,
        estimatedStartDate: "01 Feb, 2024",
        startDate: "01 Feb, 2024",
        endDate: "20 Mar, 2024",
        estimatedEndDate: "01 Jun, 2024",
        estimatedDuration: "4 months",
        actualDuration: "1.7 months",
  ...
  const handleCreateProgram = () => {
    console.log('Navigating with program data:', program);
    navigate('/dashboard/programs/create', { state: { programData: program } });
  };
  const handleCreateProject = () => {
    console.log('Navigating with program data:', program);
    navigate('/dashboard/projects/create', { state: { programData: program } });
  };
  const handleCreateProduct = () => {
    console.log('Navigating with program data:', program);
    navigate('/dashboard/products/create', { state: { programData: program } });
  };
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className=" px-6 py-2 flex items-center justify-between">
        <div className="flex items-center space-x-3">
          <ArrowLeft className="w-5 h-5 font-bold text-[#2D3748]" onClick={() => navigate('/dashboard/programs')} style={{cursor: 'pointer'}} />
                    <h1 className="text-xl font-bold text-[#2D3748]">Program Details</h1>
        </div>
      </div>
          ...
          <div className="bg-white rounded-lg shadow-sm">
            ...
            <div className="p-6 pb-4">
              <div className="flex items-center justify-between mb-4">
                <h2 className="text-lg font-bold text-[#2D3748]">Program Overview</h2>
            ...
            {/* Scrollable Content */}
            <div className="px-6 pb-6 overflow-x-auto project-detail-scroll">
              <div className="flex space-x-8 min-w-max pb-2">
                ...
                <div className="flex items-center space-x-3 min-w-0">
                  ...
                  <div className="text-sm">
                    ...
                    <div className="text-sm text-gray-600 whitespace-nowrap">Program</div>
                  </div>
                </div>
    ...
    <path fill="currentColor" d="M8 16h2V8H8zm4 0l6-4l-6-4zm0 6q-2.075 0-3.9-.788t-3.175-2.137T2.788 15.9T2 12t.788-3.9t2.137-3.175T8.1 2.788T12 2t3.9.788t3.175 2.137T21.213 8.1T22 12t-.788 3.9t-2.137 3.175t-3.175 2.138T12 22m0-2q3.35 0 5.675-2.325T20 12t-2.325-5.675T12 4T6.325 6.325T4 12t2.325 5.675T12 20m0-8"></path>
                ...
                />
                  <div>
                    <div className="text-2xl font-bold text-gray-900">2</div>
                    <div className="text-sm text-gray-600 whitespace-nowrap">In progress</div>
                  </div>
                </div>
 ...
 <div>
                ...
                <div className="flex items-center space-x-3 min-w-0">
                  ...
                  <div>
                    <div className="text-2xl font-bold text-gray-900">2</div>
                    <div className="text-sm text-gray-600 whitespace-nowrap">Suspended</div>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-3 min-w-0">
                  ...
                  />                  <div>
                      <div className="text-2xl font-bold text-gray-900">2</div>
                      <div className="text-sm text-gray-600 whitespace-nowrap">Completed</div>
                        </div>
                </div>
              ...
              {isOverviewExpanded && (
                <div className="mt-6 space-y-4">
                  {/* Products Row */}
                  <div className="flex items-center space-x-8 min-w-max pb-2">
                    <div className="flex items-center space-x-3 min-w-0">
                      <svg xmlns="http://www.w3.org/2000/svg" width={36} height={36} viewBox="0 0 512 512" className="text-[#718096] flex-shrink-0">
                        <path fill="currentColor" d="M136 24H16v120h120Zm-32 88H48V56h56Zm32 88H16v120h120Zm-32 88H48v-56h56Zm32 88H16v120h120Zm-32 88H48v-56h56Zm32 88H16v120h120Zm-32 88H48v-56h56Zm72-440.002h320v32H176zm0 88h256v32H176zm0 88h320v32H176zm0 88h256v32H176zm0 176h256v32H176zm0-88h320v32H176z"></path>
                      </svg>
                      <div className="text-sm">
                        <div className="text-2xl font-bold text-gray-900">5</div>
                        <div className="text-sm text-gray-600 whitespace-nowrap">Products</div>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center space-x-3 min-w-0">
                      <img src="/icons/InProgress.png" alt="In Progress" className="w-10 h-10 flex-shrink-0" />
                      <div>
                        <div className="text-2xl font-bold text-gray-900">2</div>
                        <div className="text-sm text-gray-600 whitespace-nowrap">In progress</div>
                      </div>
                    ...
                    <div className="flex items-center space-x-3 min-w-0">
                      <img src="/icons/CompletedTopics.png" alt="Completed" className="w-10 h-10 flex-shrink-0" />
                      <div>
                        <div className="text-2xl font-bold text-gray-900">2</div>
                        <div className="text-sm text-gray-600 whitespace-nowrap">Completed</div>
                      </div>
                  ...
                  <div className="flex items-center space-x-8 min-w-max pb-2">
                    <div className="flex items-center space-x-3 min-w-0 mr-1">
                      ...
                      <div className="text-sm">
                        <div className="text-2xl font-bold text-gray-900">5</div>
                        <div className="text-sm text-gray-600 whitespace-nowrap">Projects</div>
                      </div>
                    </div>
          ...
          <div className="col-span-2">
            <div className="bg-white rounded-lg p-6 shadow-sm">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-lg font-semibold text-gray-800">About Program</h2>
              ...
              <div className="mb-8">
                ...
                <div className="flex flex-wrap gap-2">
                  {program?.technology?.map((tech: string) => (
              ...
              <div className="grid grid-cols-4 gap-6 text-sm mb-6">
                <div>
                  ...
                  <div className="font-medium text-gray-800">{program?.estimatedStartDate || '—'}</div>
                </div>
                <div>
                  <div className="text-gray-500 mb-2">Start date</div>
                  <div className="font-medium text-gray-800">{program?.startDate || '—'}</div>
                </div>
                <div>
                  <div className="text-gray-500 mb-2">Estimated end date</div>
                  <div className="font-medium text-gray-800">{program?.estimatedEndDate || '—'}</div>
                </div>
                <div>
                  <div className="text-gray-500 mb-2">End date</div>
                  <div className="font-medium text-gray-800">{program?.endDate || '—'}</div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-3 gap-6 text-sm">
                <div>
                  ...
                  <div className="font-medium text-gray-800">{program?.estimatedDuration || '—'}</div>
                </div>
                <div>
                  <div className="text-gray-500 mb-2">Estimated budget</div>
                  <div className="font-medium text-gray-800">{program?.estimatedBudget || '—'}</div>
                </div>
                <div>
                  <div className="text-gray-500 mb-2">Budget</div>
                  <div className="font-medium text-gray-800">{program?.budget || '—'}</div>
                </div>
              </div>
            </div>
            {/* Topics List */}
            ...
            <div className="col-span-1">
              <div className="flex gap-3 mb-6">
                ...
                onClick={handleCreateProject}
                  className="bg-[#2563eb] hover:bg-blue-700 text-white font-medium px-5 py-2 rounded-full disabled:bg-gray-400 disabled:cursor-not-allowed"
              ...
              <div className="bg-white rounded-lg p-6 shadow-sm">
                <div className="flex items-center justify-between mb-4">
                  <h2 className="text-lg font-semibold text-gray-800">Program Team</h2>
                  <div className="relative">
                    <button
