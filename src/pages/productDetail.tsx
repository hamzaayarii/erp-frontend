...
<svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24">
  ...
  useEffect(() => {
    ...
    const fetchProductData = async () => {
      try {
        ...
        const currentProduct = products.find((p: Product) => p.id.toString() === id);
        if (currentProduct) {
    ...
    const mockTopics: Topic[] = [
      ...
      },
      {
        ...
        members: [
          ...
          { initials: "UV", gender: "female" }
        ],
        status: "Completed",
        progress: 100,
        estimatedStartDate: "15 Mar, 2024",
        startDate: "15 Mar, 2024",
        endDate: "30 Jun, 2024",
        estimatedEndDate: "15 Jul, 2024",
        estimatedDuration: "4 months",
        actualDuration: "3.5 months",
        estimatedBudget: "$12,000",
        budget: "$11,200",
        domain: "Performance"
      }
  ...
  const handleCreateProduct = () => {
    console.log('Navigating with product data:', product);
    navigate('/dashboard/products/create', { state: { productData: product } });
  };

  const handleCreateTopic = () => {
    console.log('Navigating with product data:', product);
    navigate('/dashboard/topics/create', { state: { productData: product } });
  };

  const handleCreateProject = () => {
    console.log('Navigating with product data:', product);
    navigate('/dashboard/projects/create', { state: { productData: product } });
  };
      ...
      <div className=" px-6 py-2 flex items-center justify-between">
        <div className="flex items-center space-x-3">
          <ArrowLeft className="w-5 h-5 font-bold text-[#2D3748]" />
                    <h1 className="text-xl font-bold text-[#2D3748]">Product Details</h1>
        </div>
      </div>
          ...
          <div className="bg-white rounded-lg shadow-sm">
            ...
            <div className="p-6 pb-4">
              <div className="flex items-center justify-between mb-4">
                <h2 className="text-lg font-bold text-[#2D3748]">Product Overview</h2>
 ...
 <div>
              ...
              {isOverviewExpanded && (
                <div className="mt-6 space-y-4">
                  ...
                  {/* Topics Row */}
                  <div className="flex items-center space-x-8 min-w-max pb-2">
                    <div className="flex items-center space-x-3 min-w-0 mr-3.5">
                      <svg xmlns="http://www.w3.org/2000/svg" width={36} height={36} viewBox="0 0 512 512" className="text-[#718096] flex-shrink-0">
                        <path fill="currentColor" d="M136 24H16v120h120Zm-32 88H48V56h56Zm32 88H16v120h120Zm-32 88H48v-56h56Zm32 88H16v120h120Zm-32 88H48v-56h56Zm32 88H16v120h120Zm-32 88H48v-56h56Zm72-440.002h320v32H176zm0 88h256v32H176zm0 88h320v32H176zm0 88h256v32H176zm0 176h256v32H176zm0-88h320v32H176z"></path>
                      </svg>
                      <div className="text-sm">
          ...
          <div className="col-span-2">
            <div className="bg-white rounded-lg p-6 shadow-sm">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-lg font-semibold text-gray-800">About Product</h2>
            ...
            <div className="flex gap-3 mb-6">
              ...
              <div className="bg-white rounded-lg p-6 shadow-sm">
                <div className="flex items-center justify-between mb-4">
                  <h2 className="text-lg font-semibold text-gray-800">Product Team</h2>
                  <div className="relative">
                    <button
